...
>
> **[발주자 결정 2026-09-25, 장부 #27] 게이트 목록의 유일한 원본은 `tools/gates.sh` 다.** 브리프는 목록을 손으로 쓰지 않고 "원본 파일을 따른다" + 신규 게이트만 적는다. 케이스 수 같은 개수도 브리프에 쓰지 않는다(개수는 이 문서와 harnesstest 가 소유).
>
